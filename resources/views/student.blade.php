                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="dept" type="text" class="form-control"  placeholder="Enter Department">
                            </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>ID</label>
                                <input value="{{ $student->id }}" name="id" type="text" class="form-control"  placeholder="Enter the first name">
                            </div>
                            ...
                            <div class="form-group">
                                <label>Dept</label>
                                <input value="{{ $student->dept }}" name="dept" type="text" class="form-control"  placeholder="Enter Department">
                            </div>
